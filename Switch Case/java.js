...
function calcular(){
    let produto = Number(document.getAnimations("pdt").value);
    ...
    document.getElementById("total2").innerHTML = "pdt" + nome + "<br>" + "qtd" + quantidade + "<br>" + "total R$" + total.toFixed(2) + "<br>" + mensagem;
}